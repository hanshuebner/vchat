...
#    print STDERR "p: $page q: $query\n";
	...
	print "</table>\r\n";
#	print "<br>\n[ <a href=\"https://gabe1.h3q.com/mrtg/vchat.berlin.ccc.de/\">vchat user-mrtg</a> ]\n";
	print "</body>\n";
        print "</html>\n";
	return;
	...
	print "Server: vchat-rd/1.0\r\n";
        ...
        print "<rss version=\"2.0\" ".
              ...
              "  <description>vchat brain dump</description>\n".
		...
		print "  <item>\n".
			...
			"    <link>".$$entry[5]."</link>\n".
			    ...
			    "    <dc:creator>".$$entry[7]."</dc:creator>\n".
				"    <dc:date>".$$entry[0]."$timediff</dc:date>\n".
				    "  </item>\n"; 
	    } else {
		last;
	    }
